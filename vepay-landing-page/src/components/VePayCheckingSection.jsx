...
import accountImage from "../assets/vepay-checking.png"; // Image for the section
        ...
        <section className="vepay-checking-section">
            <div className="vepay-container">
                ...
                <div className="vepay-image-container">
                    <img src={accountImage} alt="VePay Checking Account" />
                </div>
                ...
                <div className="vepay-content">
                    ...
                    <button className="vepay-button">Sign Up for Early Access</button>
                </div>
            </div>
        </section>
    );

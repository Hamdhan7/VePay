...
import fundingImage from "../assets/funding.png"; // Replace with actual image
import marketplace1 from "../assets/marketplace1.png"; // Replace with actual logos
    ...
    return (
        <section className="card-section">
            <div className="card-container">
                {/* InstaPay Card */}
                <div className="card instapay-card" style={{backgroundImage: `url(${instaPayBg})`}}>
                ...
                {/* VeFund Card */}
                <div className="card vefund-card">
